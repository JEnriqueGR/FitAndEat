package com.example.fitandeat.exercise.repository

import com.example.fitandeat.R
import com.example.fitandeat.exercise.model.AlternativeExercise
...
object ExercisesRepository {
            ...
            Exercise(
                ...
                alternativas = listOf(
                    AlternativeExercise(
                        ...
                        R.drawable.converging_chest_machine
                    )
                ),
                musculo = "Pecho"
            ),
            ...
            Exercise(
                ...
                alternativas = listOf(
                    AlternativeExercise(
                        ...
                        R.drawable.standing_overhead_barbell_press
                    ),
            ...
            Exercise(
                ...
                alternativas = listOf(
                    AlternativeExercise(
                        ...
                        R.drawable.overhead_rope_extension
                    ),
            ...
            Exercise(
                ...
                alternativas = listOf(
                    AlternativeExercise(
                        ...
                        R.drawable.overhead_dumbbell_extension
                    ),
    ...
    fun buscarPorNombre(nombre: String): Exercise? { return obtenerEjercicios().firstOrNull { it.nombre == nombre } }
}